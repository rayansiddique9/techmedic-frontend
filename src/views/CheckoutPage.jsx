...
export default function CheckoutPage() {
    ...
    const [authtoken, , , , , , cartitems, , subtotal,] = useContext(context);
        ...
        <>
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 py-10">
                <div className="px-4 pt-8">
                    ...
                    { cartitems.productArr.map(r => <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                    ...
                    <div className="">
                        ...
                        <div className="flex flex-col sm:flex-row">
                            <div className="relative flex-shrink-0 sm:w-7/12">
                                <input onChange={(e) => handleChange(e, setAddress)} value={address} type="text" id="billing-address" name="billing-address" className="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Street Address" />
                        ...
                        <div className="mt-6 flex items-center justify-between">
                            ...
                            <p className="text-2xl font-semibold text-gray-900">        {(subtotal+500).toLocaleString()}
                            </p>
                        </div>
                    </div>
                    <button  onClick={() => placeOrder()} className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Place Order</button>
                </div>
            </div>
        </>
